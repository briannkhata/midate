            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Multi Columns Form -->
                        <form class="row g-3" action="<?=base_url();?>admin/updateSlide" method="post"
                            ...
                            <div class="col-md-12">
                                <img src="<?=base_url();?>uploads/slides/<?=$row['image'];?>">
                            </div>


                            <div class="col-md-12">
                                <label for="inputPassword5" class="form-label">Description</label>
                                <textarea class="form-control tinymce-editor" name="desc"><?=$row['desc'];?></textarea>
                            </div>

                            <div class="col-md-12">
                                <label for="inputPassword5" class="form-label">Details</label>
                                <textarea class="form-control tinymce-editor" name="details">
                                    <?=$row['details'];?>
                                </textarea>
                            </div>
