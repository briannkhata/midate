    ...
    <!-- ==========Breadcrumb-Section========== -->
     ...
     <section class="membership-section">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="content">
                        <div class="section-header">
                            ...
                            <p class="text">
                                Benefit from miDate at its maximum you!
                            </p>
                        </div>
                    </div>
                </div>
             ...
             <div class="row m-s-top">
                <div class="col-lg-3 col-md-6">
                    <div class="plan-info">
                        <div class="icon">
                            <img src="<?=base_url();?>assets//images/membership/icon1.png" alt="">
                        </div>
                        <h4 class="title">
                            Unlimited Messages 
                        </h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="plan-info">
                        <div class="icon">
                            <img src="<?=base_url();?>assets//images/membership/icon2.png" alt="">
                        </div>
                        <h4 class="title">
                            VIP Badge
                        </h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="plan-info">
                        <div class="icon">
                            <img src="<?=base_url();?>assets//images/membership/icon3.png" alt="">
                        </div>
                        <h4 class="title">
                            Unlimited matches 
                        </h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="plan-info">
                        <div class="icon">
                            <img src="<?=base_url();?>assets//images/membership/icon4.png" alt="">
                        </div>
                        <h4 class="title">
                            Take more messages  
                        </h4>
             ...
             <div class="row">
                 <div class="col-lg-12">
                    <div class="pricing-plan-wrapper">
                        <img class="left-img" src="<?=base_url();?>assets//images/membership/left-img.png" alt="">
                        <img class="right-img" src="<?=base_url();?>assets//images/membership/right-img.png" alt="">
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
         ...
         <div class="pricing-plans">
            <img class="shape1" src="<?=base_url();?>assets//images/join/heartshape.png" alt="">
             <div class="container">
                 <div class="row">
                     <div class="col-lg-12">
        ...
        <div class="container">
            ...
            <div class="faq-area">
                <div class="faq-wrapper">
                    <div class="faq-item">
                        <div class="faq-title">
                            <h6 class="title">What is miDate? </h6>
